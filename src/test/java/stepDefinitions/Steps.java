...
public class Steps {
	WebDriver driver=BrowserUtil.startBrowser("chrome","https://phptravels.com/demo/");
	RequestFormPage rf;

	@Given("User is on Request Form page {string}")
	public void user_is_on_request_form_page(String url) {
